...
public data class AddTrackFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): AddTrackFragmentArgs {
      bundle.setClassLoader(AddTrackFragmentArgs::class.java.classLoader)
      val __albumId : Int
      ...
      return AddTrackFragmentArgs(__albumId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): AddTrackFragmentArgs {
      val __albumId : Int?
